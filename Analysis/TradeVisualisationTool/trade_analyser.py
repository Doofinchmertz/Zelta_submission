...
def plot_trade(df, entry_idx, exit_idx, trade_type, title, lookback=20):
    # Create subplots and mention plot grid size
        # loolkback is the number of candles to show before and after the entry and exit
        ...
        # # we can also add other indicators on 1st row as below
        ...
        fig.update_layout(title_text=f"{'Long' if trade_type == 1 else 'Short'}" + title, title_x=0.5, title_font_size=20, title_font_color="black", title_font_family="Courier New")
